...
% ------------------------------------------------------------------------------
\begin{frame}
  \frametitle{Link order vs. time (no ccache, 8GB, 8+8 cores, 4 jobs)}
  \fitfig{time-llvm-8GB-ld-noccache-1j-4j.pdf}
\end{frame}
% ------------------------------------------------------------------------------
\begin{frame}
...
% ------------------------------------------------------------------------------
\begin{frame}
  \frametitle{Link order vs. time (no ccache, 8GB, 8+8 cores, 24 jobs)}
  \fitfig{time-llvm-8GB-ld-noccache-1j-24j.pdf}
\end{frame}
% ------------------------------------------------------------------------------
\begin{frame}
